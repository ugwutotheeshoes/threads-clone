    ...
    return (
        <View style={styles.container}>
            ...
            <View style={{ gap: 6, flexShrink: 1 }}>
                ...
                {thread.image && (
                    <Image source={thread.image} style={{ width: "100%", minHeight: 300, borderRadius: 10 }} placeholder={blurhash} contentFit='cover' transition={200} />
                )}
                <BottomIcons />
...
function PostLeftSide(thread: Thread) {
    ...
    return (
        <View style={{ justifyContent: "space-between" }}>
            <Image source={thread.author.photo}
                style={styles.image}
